    ...
    <>
      ...
      >
        ...
        <div className="grow flex flex-col items-center justify-center">
          <div className="title-container relative flex items-center justify-center">
            <img
              // width="100%"
              // height="auto"
          ...
          <div className="subtitle-container mt-10 md:mt-20 mb-4">
            <p>a social pomodoro timer</p>
            <p>25 minutes of focus · 5 minutes of chat</p>
          </div>
          <Link
            href="/timer"
            className="bg-ink text-cream rounded-full px-10 py-4
